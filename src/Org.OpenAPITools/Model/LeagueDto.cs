...
namespace Org.OpenAPITools.Model
{
    ...
    /// LeagueDto
    /// </summary>
    [DataContract(Name = "league-dto")]
    public partial class LeagueDto : IValidatableObject
    {
        /// <summary>
        ...
        public LeagueDto(long id = default(long), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string name = default(string))
        {
            this.Id = id;
