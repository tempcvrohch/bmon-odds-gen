...
namespace Org.OpenAPITools.Api
{
    ...
    /// </summary>
    public interface IBetApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBetApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IBetApi : IBetApiSync, IBetApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class BetApi : IBetApi
    {
        private Org.OpenAPITools.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="BetApi"/> class.
        /// </summary>
        /// <returns></returns>
        public BetApi() : this((string)null)
        {
        }
        ...
        /// <returns></returns>
        public BetApi(Org.OpenAPITools.Client.Configuration configuration)
        {
        ...
        public BetApi(Org.OpenAPITools.Client.ISynchronousClient client, Org.OpenAPITools.Client.IAsynchronousClient asyncClient, Org.OpenAPITools.Client.IReadableConfiguration configuration)
        {
        ...
        public Org.OpenAPITools.Client.ApiResponse<BetDto> PlaceBetWithHttpInfo(string X_XSRF_TOKEN, long marketStateId, BetPlaceDto betPlaceDto, int operationIndex = 0)
        {
            ...
            if (betPlaceDto == null)
            {
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'betPlaceDto' when calling BetApi->PlaceBet");
            }
            ...
            var localVarResponse = this.Client.Post<BetDto>("/bet/place/{marketStateId}", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("PlaceBet", localVarResponse);
                if (_exception != null)
                {
                    throw _exception;
                }
        ...
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<BetDto>> PlaceBetWithHttpInfoAsync(string X_XSRF_TOKEN, long marketStateId, BetPlaceDto betPlaceDto, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.PostAsync<BetDto>("/bet/place/{marketStateId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
